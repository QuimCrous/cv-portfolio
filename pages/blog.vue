              ...
              <div class="info">
                <h4>
                  <a
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#blogSingleModal"
                    >Discovery earnestly public commanded mentions.</a
                  >
                </h4>
                <div class="meta">
                  <ul>
              ...
              <div class="info">
                <h4>
                  <a
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#blogSingleModal"
                    >Considered imprudence of he friendship boisterous.</a
                  >
                </h4>
                <div class="meta">
                  <ul>
              ...
              <div class="info">
                <h4>
                  <a
                    ...
                    data-bs-toggle="modal"
                    data-bs-target="#blogSingleModal"
                    >Overcame breeding or my concerns removing desirous.</a
                  >
                </h4>
                <div class="meta">
                  <ul>
                ...
                <div class="info">
                  <div class="meta">
                    <ul>
                      ...
                      <li>
                        <a href="#"
                          ><i class="fas fa-comments"></i> 26 Comments</a
                        >
                      </li>
                    </ul>
                  </div>
...
useHead({
  script: [
    ...
    {
      src: "/js/modernizr.custom.13711.js",
      body: true,
      type: "text/javascript",
      charset: "utf-8",
    },
    ...
    {
      src: "/js/jquery.scrolla.min.js",
      body: true,
      type: "text/javascript",
      charset: "utf-8",
    },
    {
      src: "/js/YTPlayer.min.js",
      body: true,
      type: "text/javascript",
      charset: "utf-8",
    },
